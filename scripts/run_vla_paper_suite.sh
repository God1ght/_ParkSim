...
for background_mode in $BACKGROUND_MODES; do
  for density in $DENSITY_CONFIGS; do
    ...
    PARKSIM_BENCH_LONG_HORIZON_HUMAN_ENTER_INTERVAL_MEAN="$LONG_HORIZON_HUMAN_ENTER_INTERVAL_MEAN" \
    PARKSIM_BENCH_LONG_HORIZON_HUMAN_EXIT_INTERVAL_MEAN="$LONG_HORIZON_HUMAN_EXIT_INTERVAL_MEAN" \
    PARKSIM_BENCH_LONG_HORIZON_AV_ENTER_INTERVAL_MEAN="$LONG_HORIZON_AV_ENTER_INTERVAL_MEAN" \
    PARKSIM_BENCH_LONG_HORIZON_AV_EXIT_INTERVAL_MEAN="$LONG_HORIZON_AV_EXIT_INTERVAL_MEAN" \
