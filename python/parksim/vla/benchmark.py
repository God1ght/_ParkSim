...
PREFERRED_FIELDS = [
    ...
    "feedback_repair_success_rate", "feedback_hard_violation_reduction_count", "feedback_hard_violation_reduction_rate",
    "feedback_quality_warning_reduction_count", "feedback_quality_warning_reduction_rate",
    "feedback_route_conflict_reduction_count", "feedback_route_conflict_reduction_rate",
