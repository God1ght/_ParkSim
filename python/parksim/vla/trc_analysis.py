...
METRIC_GROUPS = {
    ...
    "cloud_invocation_budget": ["cloud_fleet_event_trigger_epoch_count", "cloud_fleet_watchdog_epoch_count", "cloud_fleet_actionable_epoch_count", "cloud_fleet_empty_epoch_count", "cloud_fleet_vehicle_decision_count"],
