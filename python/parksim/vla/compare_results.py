...
def collect_mode_metrics(experiment_dir: Path, mode: str) -> Dict[str, Any]:
    ...
    metrics = {
        ...
        "simulation_step_seconds": _safe_float(summary.get("simulation_step_seconds"), _safe_float(first.get("simulation_step_seconds"), 0.0)),
        "simulation_speedup": _safe_float(summary.get("simulation_speedup"), _safe_float(first.get("simulation_speedup"), 1.0)),
        "audit_wall_timer_period_seconds": _safe_float(summary.get("wall_timer_period_seconds"), _safe_float(first.get("wall_timer_period_seconds"), 0.0)),
...
def write_metrics(experiment_dir: Path, collected: Dict[str, Dict[str, Any]]) -> None:
    ...
    fields = [
        ...
        "automated_demand_released_count", "automated_demand_completed_count", "automated_demand_backlog_count",
        "automated_demand_service_rate", "automated_throughput_per_sim_hour",
        "fleet_mean_automated_path_length", "fleet_mean_automated_waiting_time", "fleet_mean_automated_total_time",
